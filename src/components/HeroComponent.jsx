...
export default function HeroComponent({
  badgeText = "THE PREMIUM ARCHIVE",
  headingText = "Curation With",
  highlightedHeading = "Scholarly Care.",
  description = "Access a world-class collection of literature, meticulously curated and delivered with the precision of a modern scholarly archive.",
  placeholder = "Search your next masterpiece...",
  searchRedirectPath = "/search", // ডিফল্ট সার্চ পেজ পাথ
  imageUrl = "https://images.unsplash.com/photo-1513001900722-370f803f498d?q=80&w=800",
  imageTag = "Just Added",
  imageTitle = "The Architecture of Literary Heritage",
  stats = [
    { value: "12,400+", label: "ACTIVE READERS", highlight: false },
    { value: "4.98", label: "AVERAGE RATING", highlight: true }
  ]
}) {
  const router = useRouter();
  const searchParams = useSearchParams();
  
  // URL থেকে বর্তমান সার্চ কি-ওয়ার্ড নিয়ে স্টেট ডিক্লেয়ার করা
  ...
  const handleSearchSubmit = (e) => {
    ...
    // ইউজারকে প্রপস-এ দেওয়া পাথে এনকোড করা কোয়েরিসহ রিডাইরেক্ট করবে
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mt-10 w-full max-w-xl">
            ...
            >
              ...
              <button
                type="submit"
                className="rounded-2xl bg-[#1A2332] hover:bg-black px-8 py-4 font-semibold text-white shadow-lg flex items-center gap-3 transition-all duration-300"
              >
                Explore
        ...
        <div className="lg:col-span-5 relative flex justify-center">
          ...
          >
            ...
            <div className="absolute bottom-8 left-8 right-8 text-white">
              <p className="uppercase tracking-[2px] text-[#C5A059] text-xs font-bold">{imageTag}</p>
              <h3 className="text-2xl font-bold leading-tight mt-2">{imageTitle}</h3>
            </div>
          </motion.div>
