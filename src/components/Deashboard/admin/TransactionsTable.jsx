  ...
  if (!transactions || transactions.length === 0) {
    return (
      <div className="bg-white border border-slate-200 rounded-2xl p-12 text-center shadow-sm flex flex-col items-center justify-center">
        ...
        <h3 className="text-base font-bold text-[#040d1b] mb-1">No Transactions Found</h3>
                  ...
                  <td className="p-4 pl-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="max-w-[220px] sm:max-w-xs">
                        <p className="font-mono text-[11px] font-bold text-[#775a19] tracking-tight bg-amber-50/60 border border-amber-100 px-1.5 py-0.5 rounded inline-block">
                          ID: {txId}
                        </p>
                        <p className="font-bold text-[#040d1b] leading-tight mt-1 truncate" title={tx.title}>
